...
import { voteAnecdote, setFilter, initializeAnencdotes, handleVoteInDb, handleDeleteInDb } from '../reducers/store'
...
function AnecdoteList() {
  ...
  const deleteAnecdote = (anecdote) => {
    console.log('Deleting anecdote with id:', anecdote) // Debugging
    dispatch(handleDeleteInDb(anecdote))
    alert(`Anecdote '${anecdote.content}' deleted!`)
  }
